...
if __name__ == '__main__':
    ...
    with open('BARELAND.csv', mode='w', newline='') as file:
        writer = csv.writer(file)
     
        writer.writerow(['image_name', 'response'])
        
        for image_file in image_files:
            gpt_response = get_gpt_description([image_file], API_KEY, " What percentage of the satellite image cover BARELAND OR ROCKS ,please give only the NUMBER in the table")
